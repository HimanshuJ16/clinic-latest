...
const Profile = ({doctorData}) => {
  ...
  const addQualification = e => {
    e.preventDefault();
    addItem("qualifications", {startingDate: "", endingDate: "", degree: "PHD", university: "ABC University"});
  };
  ...
  const addExperience = e => {
    e.preventDefault();
    addItem("experiences", {startingDate: "", endingDate: "", position: "MD", hospital: "XYZ hospital"});
  };
    ...
    <div>
      ...
      <form>
        ...
        <div className='mb-5'>
          ...
          <input readOnly aria-readonly disabled={true} type="email" name='email' value={formData.email} onChange={handleInputChange} placeholder='Email' className='form__input' />
        </div>
        <div className='mb-5'>
        ...
        <div className="mb-5">
          <div className='grid grid-cols-3 gap-5 mb-[30px]'>
            ...
            <div>
              ...
              <input type="text" name='specialization' value={formData.specialization} onChange={handleInputChange} placeholder='Specialization' className='form__input py-3.5' maxLength={50} />
            </div>
            <div>
              <p className='form__label'>Ticket Price*</p>
              <input type="number" name='ticketPrice' value={formData.ticketPrice} onChange={handleInputChange} placeholder='100' className='form__input py-3.5' />
            </div>
          </div>
        </div>
        <div className="mb-5">
              ...
              <div>
                <div className='grid grid-cols-2 md:grid-cols-4 mb-[30px] gap-5'>
                  ...
                  <div className='flex items-center'>
                    <button onClick={e => deleteTimeSlot(e, index)} className='bg-red-600 p-2 rounded-full text-white text-[18px] mt-7 cursor-pointer'>
                      <AiOutlineDelete />
                    </button>
                  </div>
                </div>
        ...
        <div className='mt-7'>
          <button type='submit' onClick={updateProfileHandler} className='w-full bg-primaryColor text-white text-[18px] leading-[30px] py-3 px-4 rounded-lg'>
            Update Profile
          </button>
        </div>
      </form>
